...
namespace XLua.CSObjectWrap
{
    ...
    public class AssetBundlesAssetBundleManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "assetbundlesCaching", _g_get_assetbundlesCaching);
            
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "IsInitialized", _s_set_IsInitialized);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "assetbundlesCaching", _s_set_assetbundlesCaching);
		    ...
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Action<UnityEngine.Object>>(L, 3)) 
                {
                    ...
                    System.Action<UnityEngine.Object> _callBack = translator.GetDelegate<System.Action<UnityEngine.Object>>(L, 3);
                        ...
                        AssetBundles.BaseAssetBundleAsyncLoader gen_ret = gen_to_be_invoked.LoadAssetBundleAsync( _assetbundleName, _callBack );
                        translator.Push(L, gen_ret);
        ...
        static int _m_DownloadAssetFileAsync(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _isLoadBundle = LuaAPI.lua_toboolean(L, 3);
                    
                        AssetBundles.ResourceWebRequester gen_ret = gen_to_be_invoked.DownloadAssetFileAsync( _filePath, _isLoadBundle );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to AssetBundles.AssetBundleManager.DownloadAssetFileAsync!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_assetbundlesCaching(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                AssetBundles.AssetBundleManager gen_to_be_invoked = (AssetBundles.AssetBundleManager)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.assetbundlesCaching);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_IsInitialized(RealStatePtr L)
        {
		    try {
                ...
                AssetBundles.AssetBundleManager gen_to_be_invoked = (AssetBundles.AssetBundleManager)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.IsInitialized = LuaAPI.lua_toboolean(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_assetbundlesCaching(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                AssetBundles.AssetBundleManager gen_to_be_invoked = (AssetBundles.AssetBundleManager)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.assetbundlesCaching = (System.Collections.Generic.Dictionary<string, UnityEngine.AssetBundle>)translator.GetObject(L, 2, typeof(System.Collections.Generic.Dictionary<string, UnityEngine.AssetBundle>));
