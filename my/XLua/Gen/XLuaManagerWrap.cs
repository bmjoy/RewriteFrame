...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "m_path", _g_get_m_path);
            
			Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "m_path", _s_set_m_path);
        ...
        static int _g_get_m_path(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, XLuaManager.m_path);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_m_path(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    XLuaManager.m_path = (System.Collections.Generic.List<string>)translator.GetObject(L, 1, typeof(System.Collections.Generic.List<string>));
