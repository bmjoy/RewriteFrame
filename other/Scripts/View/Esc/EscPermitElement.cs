...
public class EscPermitElement : MonoBehaviour
{
    /// <summary>
    /// 模型
    /// </summary>
    ...
    public void Init()
    {
        ...
        m_Label.text = TableUtil.GetLanguageString("esc_title_1004");
    ...
    public void ShowModel()
    {
        ...
        UiModel m_UiModel = m_CfgEternityProxy.GetUiModel("Esc_1001");
