...
public class PackageIconDeviceElement : MonoBehaviour
{
    /// <summary>
    /// 空物品
    /// </summary>
    ...
    public void SetData(ItemEquipmentVO Vo)
    {
        Initialize();
        ...
        m_LvLabel.text = sstr;
        m_TypeLabel.text = TableUtil.GetLanguageString(Vo.EquipmentType);
    }
}
