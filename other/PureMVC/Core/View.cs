...
namespace PureMVC.Core
{
    ...
    public class View: IView
    {
        ...
        public View()
        {
            ...
            instance = this;
            mediatorMap = new ConcurrentDictionary<UIPanel, IMediator>();
        ...
        public virtual IMediator RetrieveMediator(UIPanel mediatorName)
        {
        ...
        public virtual IMediator RemoveMediator(UIPanel mediatorName)
        {
        ...
        public virtual bool HasMediator(UIPanel mediatorName)
        {
            return mediatorMap.ContainsKey(mediatorName);
        }

        /// <summary>Mapping of Mediator names to Mediator instances</summary>
        protected readonly ConcurrentDictionary<UIPanel, IMediator> mediatorMap;
