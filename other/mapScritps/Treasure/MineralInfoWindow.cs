...
namespace Map
{
    ...
    /// </summary>
    [ExecuteInEditMode]
    public class MineralInfoWindow : EditorWindow
    {
        private static MineralInfoWindow sm_TreasureWin;
            ...
            if (gamingArea != null)
            {
                ...
                if (areas != null && areas.Length > 0)
                {
                    for (int iArea = 0; iArea < areas.Length; iArea++)
                    {
                        ...
                        {
                            m_Marks = area.GetMineralSemaphoreMarks();
                            m_RootMark = area.m_MineralRoot;
                        }
                    }
                }
            }
