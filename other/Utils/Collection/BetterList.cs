...
/// unordered, fast
/// </summary>
public sealed class BetterList<T> : IEnumerable, ICollection, IList, IEnumerable<T>, ICollection<T>, IList<T>
{
	...
	public struct Enumerator : IEnumerator<T>, IEnumerator
	{
		...
		internal Enumerator(BetterList<T> list)
		{
			m_List = list;
			m_Index = 0;
